   ...
   const handleSubmit = (e: React.FormEvent) => {
     ...
     setTimeout(() => {
       const newResponse: QueryResponse = {
         ...
         explanation:
           "This response was generated by analyzing 1,234 documents across your connected knowledge sources. Key factors include: document relevance scoring, cross-reference validation, and contextual analysis from historical data.",
         confidence: 87,
       };
         ...
         {responses.map((response, index) => (
           ...
           >
             ...
             <div className="flex items-start gap-3">
               <div
                 className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 text-white font-medium text-xs"
