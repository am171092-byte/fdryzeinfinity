 ...
 import { Plus, Sparkles, FileText, Database, Clock, MoreHorizontal } from "lucide-react";
 ...
 const AssistantsHome = ({ onCreateNew, onSelectAssistant }: AssistantsHomeProps) => {
   return (
     <div className="p-8">
       ...
       >
         <div>
           <h1 className="text-page-title mb-2">Query Assistants</h1>
           <p className="text-muted-foreground">
             AI assistants configured for your teams
           </p>
         </div>
         <motion.button
           onClick={onCreateNew}
       ...
       {assistants.length > 0 ? (
             ...
             >
               <div className="flex items-start justify-between mb-4">
                 ...
                 <div className="flex items-center gap-2">
                   ...
                   >
                     {assistant.status === "published" ? "Published" : "Draft"}
                   </span>
         ...
         <motion.div
           ...
           animate={{ opacity: 1, y: 0 }}
           transition={{ delay: 0.1 }}
           className="card-float p-16 text-center"
         >
           ...
           <motion.button
             ...
             whileHover={{ scale: 1.02 }}
             whileTap={{ scale: 0.98 }}
             className="h-11 px-6 bg-primary hover:bg-primary-hover text-primary-foreground font-medium rounded-xl inline-flex items-center gap-2 shadow-lg shadow-primary/25 transition-all"
           >
             <Plus className="w-5 h-5" />
             Create New Assistant
           </motion.button>
